...
import Portfolio3 from '../../assets/FlagQuiz.png';
...
<div className="porfolio3">
   ...
   <p className="portfolioText">
      <a href="https://github.com/yashshah9279/Flag-Quiz.git" className="gitLink" style={{textDecoration:"none",color:"white"}}>Flag Quiz
      </a>
    </p>
</div>
